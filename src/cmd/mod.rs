...
impl Command {
    ...
    pub fn from_frame(frame: Frame) -> crate::Result<Command> {
        ...
        let command = match &command_name[..] {
            ...
            "expireat" => Command::Expire(Expire::parse_frames(&mut parse)?),
            "pexpire" => Command::Expire(Expire::parse_frames(&mut parse)?),
            "pexpireat" => Command::Expire(Expire::parse_frames(&mut parse)?),
